...
const CommonRegularText = (props) => {
    ...
    return (
      <Text style={[{fontFamily: 'Lato-Regular', fontSize: 12*em, color: propTextColor, lineHeight: 20 * em}, props.style]}>
        {props.children}
      </Text>
    );
}

export default CommonRegularText
